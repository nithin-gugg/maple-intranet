      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <section className="bg-white rounded-xl border border-hairline shadow-subtle p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">Email <span className="text-xs text-slate-400 font-normal ml-2">(Managed by Clerk)</span></label>
