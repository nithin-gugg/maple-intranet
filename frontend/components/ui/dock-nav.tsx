...
const dockNavListVariants = cva(
  "mb-0 flex list-none flex-row items-end justify-center p-0 text-[clamp(0.875rem,1.4vw,1.125rem)] gap-3",
  {
    variants: {
      align: {
...
const dockNavIconVariants = cva("h-full w-full object-cover rounded-2xl shadow-sm");

const dockNavTooltipVariants = cva(
  "pointer-events-none absolute top-0 z-0 whitespace-nowrap rounded-[0.25em] bg-white px-[0.5em] py-[0.4em] font-normal text-[1em] text-black shadow-md"
);
